                ...
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
                  ...
                  <div class="form-group">
                    ...
                    <select name="deduction" class="form-control" required>
                      ...
                      <option value="<?php echo $Medical+$tax; ?>">Medical+TAX</option>
                      <option value="<?php echo $gsis+$tax; ?>">GSIS+TAX</option>
                      <option value="<?php echo $loans+$tax; ?>">Loans+TAX</option>
                      <option value="<?php echo $loans+$tax+$Medical+$gsis; ?>">ALL</option>
                    </select>
                  </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-5 control-label">Overtime(hrs)  :</label>
                    <div class="col-sm-4">
